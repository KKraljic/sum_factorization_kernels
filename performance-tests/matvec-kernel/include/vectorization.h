...
unsigned long long int addition_ctr = 0;
unsigned long long int subtraction_ctr = 0;
unsigned long long int multiplication_ctr = 0;
unsigned long long int division_ctr = 0;
